...
//        si.setComments("备注信息暂无");
        //创建Excel表单
        SXSSFSheet sheet = workbook.createSheet("XXX集团试题信息表");
        //创建日期显示格式
        ...
        SXSSFCell cell0 = headerRow.createCell(0);
        cell0.setCellValue("编号");
        cell0.setCellStyle(headerStyle);
        SXSSFCell cell1 = headerRow.createCell(1);
        cell1.setCellValue("题目");
        cell1.setCellStyle(headerStyle);
        SXSSFCell cell2 = headerRow.createCell(2);
        cell2.setCellValue("选项A");
        cell2.setCellStyle(headerStyle);
        SXSSFCell cell3 = headerRow.createCell(3);
        cell3.setCellValue("选项B");
        cell3.setCellStyle(headerStyle);
        SXSSFCell cell4 = headerRow.createCell(4);
        cell4.setCellValue("选项C");
        cell4.setCellStyle(headerStyle);
        SXSSFCell cell5 = headerRow.createCell(5);
        cell5.setCellValue("选项D");
        cell5.setCellStyle(headerStyle);
        SXSSFCell cell6 = headerRow.createCell(6);
        cell6.setCellValue("答案");
        cell6.setCellStyle(headerStyle);
        SXSSFCell cell7 = headerRow.createCell(7);
        cell7.setCellValue("科目");
        cell7.setCellStyle(headerStyle);
        SXSSFCell cell8 = headerRow.createCell(8);
        cell8.setCellValue("分值");
        cell8.setCellStyle(headerStyle);
...
//            si.setComments("备注信息暂无");
            ...
            cell1.setCellValue("题目");
            cell1.setCellStyle(headerStyle);
            SXSSFCell cell6 = headerRow.createCell(2);
            cell6.setCellValue("答案");
            cell6.setCellStyle(headerStyle);
            SXSSFCell cell7 = headerRow.createCell(3);
            cell7.setCellValue("科目");
            cell7.setCellStyle(headerStyle);
            SXSSFCell cell8 = headerRow.createCell(4);
            cell8.setCellValue("分值");
            cell8.setCellStyle(headerStyle);
...
//        System.out.println("subjects"+subjects);
        ...
        try {
            ...
            SXSSFWorkbook workbook = new SXSSFWorkbook(sheets1,1000);
